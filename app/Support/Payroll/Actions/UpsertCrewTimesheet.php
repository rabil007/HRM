...
final class UpsertCrewTimesheet
{
    ...
    public function handle(PayrollPeriod $period, Employee $employee, array $data): CrewTimesheet
    {
        ...
        $isDaily = ($employee->currentContract?->resolvedSalaryStructure() ?? ContractSalaryStructure::Daily)
        ...
        if ($existing !== null && $existing->isOperationallyLocked()) {
            ...
            $existing->fill([
                ...
                'overtime_amount' => array_key_exists('overtime_amount', $data)
                    ? $data['overtime_amount']
                    : $existing->overtime_amount,
        ...
        if ($isCrewOperationsMode && $isDaily) {
            ...
            return CrewTimesheet::query()->updateOrCreate(
                ...
                [
                    ...
                    'overtime_amount' => $data['overtime_amount'] ?? $existing?->overtime_amount ?? 0,
