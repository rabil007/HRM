...
final class ApplyMonthlyCrewSalaryInputs
{
    /**
    ...
    public function apply(PayrollRecord $record, Collection $inputs): array
    {
        ...
        // Base unpaid leave is informational for monthly crew because gross earnings
        // are already prorated by unpaid leave days during generation.
        ...
        // Any manual salary input of type 'unpaid_leave' represents an explicit monetary adjustment.
        $manualUnpaidLeave = round($totals['unpaid_leave'], 2);
        $unpaidLeaveDeduction = round($baseUnpaidLeave + $manualUnpaidLeave, 2);
        ...
        // Only legitimate monetary deductions (loan, late, other, manual unpaid-leave adjustment)
        // are summed into total_deductions. The informational base unpaid-leave impact is excluded.
        $totalDeductions = round($manualUnpaidLeave + $lateDeduction + $loanDeduction + $otherDeductions, 2);
        ...
        $lines['informational_unpaid_leave'] = $baseUnpaidLeave;
        $lines['manual_unpaid_leave_deduction'] = $manualUnpaidLeave;
        ...
        return [
            ...
            'calculation_breakdown' => array_merge($breakdown, [
                ...
                'informational_unpaid_leave_deduction' => $baseUnpaidLeave,
                'manual_unpaid_leave_deduction' => $manualUnpaidLeave,
            ]),
        ];
    }
