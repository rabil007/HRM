...
final class CrewPayrollGenerationPreview
{
    ...
    public function toArray(bool $includeEmployeeIds = true): array
    {
        $payload = [
            ...
            'skipped_issues' => array_slice($this->groupedIssues($this->skippedIssues), 0, 25),
            'skipped_count' => $this->skippedCount,
            'automatic_adjustments' => array_slice($this->groupedIssues($this->automaticAdjustments), 0, 25),
