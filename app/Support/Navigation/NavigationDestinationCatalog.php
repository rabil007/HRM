...
final class NavigationDestinationCatalog
{
    ...
    public static function all(): array
    {
        return [
            ...
            ['key' => 'documents.templates', 'label' => 'Templates', 'href' => '/organization/documents/templates', 'group' => 'Documents', 'permissions' => ['documents.templates.view', 'bulk_documents.view', 'settings.master-data.document-types.view'], 'platform' => 'view'],
            ...
            ['key' => 'documents.requests', 'label' => 'Requests', 'href' => '/organization/documents/requests', 'group' => 'Documents', 'permissions' => ['documents.requests.view', 'documents.recipient-requests.view', 'documents.recipient-requests.respond'], 'platform' => null],
            ...
            ['key' => 'crew.vessel-manning', 'label' => 'Vessel Manning', 'href' => '/organization/vessel-manning', 'group' => 'Crew Operations', 'permissions' => ['crew_operations.vessel_manning.view'], 'platform' => null],
