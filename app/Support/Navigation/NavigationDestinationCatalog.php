...
final class NavigationDestinationCatalog
{
    ...
    public static function all(): array
    {
        return [
            ...
            ['key' => 'documents.templates', 'label' => 'Templates', 'href' => '/organization/documents/templates', 'group' => 'Documents', 'permissions' => ['documents.templates.view', 'bulk_documents.view', 'settings.master-data.document-types.view'], 'platform' => null],
