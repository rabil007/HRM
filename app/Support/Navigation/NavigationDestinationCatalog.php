...
final class NavigationDestinationCatalog
{
    ...
    public static function all(): array
    {
        return [
            ...
            ['key' => 'reports.leave', 'label' => 'Leave Report', 'href' => '/organization/reports/leave', 'group' => 'Reports', 'permissions' => ['reports.leave.view'], 'platform' => null],
            ['key' => 'reports.leave_balance', 'label' => 'Leave Balance Report', 'href' => '/organization/reports/leave-balances', 'group' => 'Reports', 'permissions' => ['reports.leave_balance.view'], 'platform' => null],
