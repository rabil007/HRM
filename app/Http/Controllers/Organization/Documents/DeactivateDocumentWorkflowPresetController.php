...
class DeactivateDocumentWorkflowPresetController extends Controller
{
    public function __invoke(
        Request $request,
        DocumentWorkflowPreset $workflowPreset,
        DeactivateDocumentWorkflowPreset $action,
    ): RedirectResponse {
        ...
        return back()->with('success', 'Workflow preset deactivated.');
    }
}
