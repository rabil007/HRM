...
use App\Support\Documents\Signing\Actions\ActivateDocumentSigningPreset;
use Illuminate\Http\RedirectResponse;
use Illuminate\Http\Request;

class ActivateDocumentSigningPresetController extends Controller
{
    public function __invoke(
        Request $request,
        DocumentSigningPreset $signingPreset,
        ActivateDocumentSigningPreset $action,
    ): RedirectResponse {
        ...
        return back()->with('success', 'Signing preset activated.');
    }
}
