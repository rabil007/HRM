...
class UpdateDocumentSigningPresetRequest extends FormRequest
{
    public function authorize(): bool
    {
        return $this->user()?->can('documents.signing-presets.update') ?? false;
    }
    ...
    public function rules(): array
    {
        ...
        $preset = $this->route('signingPreset');
