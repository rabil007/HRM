...
final class SeaServicesImport
{
    ...
    private const COL_VESSEL_TYPE = 'C';

    private const COL_VESSEL = 'D';

    private const COL_RANK = 'E';

    private const COL_START_DATE = 'F';

    private const COL_END_DATE = 'G';
    ...
    public function parse(UploadedFile $file): array
    {
        ...
        for ($rowNumber = self::DATA_START_ROW; $rowNumber <= $highestRow; $rowNumber++) {
            ...
            $rows[] = [
                ...
                'vessel_type' => $this->stringValue($sheet, self::COL_VESSEL_TYPE, $rowNumber),
                'vessel' => $this->stringValue($sheet, self::COL_VESSEL, $rowNumber),
                'rank' => $this->stringValue($sheet, self::COL_RANK, $rowNumber),
