...
test('quality gates fail when frontend types fails', function () {
    $result = oms_ci_evaluate_quality_gates([
        'changes_result' => 'success',
        'pint_result' => 'success',
        'frontend_static_result' => 'success',
        'frontend_types_result' => 'failure',
        'frontend_build_result' => 'success',
        'pest_result' => 'success',
        'run_pint' => true,
        'run_frontend_static' => true,
    ...
    expect($result['ok'])->toBeFalse()
        ->and($result['errors'])->toContain('TypeScript did not succeed (result=failure).');
});
