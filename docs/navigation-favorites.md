...
This phase does **not** favorite business records (employees, documents, crew assignments). Recently viewed records are [Recent items](./recent-items.md). Named list-filter combinations are [Saved views](./saved-views.md).
