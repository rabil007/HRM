...
| [Crew Movement Phases](./architecture/crew-movement-phases.md) | Operations, developers | P0–P6 lifecycle, Tour of Duty Phase 1, Relief Readiness Phase 2A, Projected Manning Engine Phase 2B.1, Projected Manning UI Phase 2B.2, Daily Operations Dashboard Phase 2B.3A, Planning Gantt Projection Overlays Phase 2B.3B, Transfer / Redeployment Tour Hardening Phase 2C.1, Transfer / Redeploy Tour UI Phase 2C.2, planning sync, sea service |
