...
| [Crew Movement Phases](./architecture/crew-movement-phases.md) | Operations, developers | P0–P6 lifecycle, Tour of Duty Phase 1, Relief Readiness Phase 2A, Projected Manning Engine Phase 2B.1, planning sync, sea service |
