...
| [Crew Movement Phases](./architecture/crew-movement-phases.md) | Operations, developers | P0–P6 lifecycle, Tour of Duty Phase 1, Relief Readiness Phase 2A, planning sync, sea service |
