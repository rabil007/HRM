...
| [Crew Movement Phases](./architecture/crew-movement-phases.md) | Operations, developers | P0–P6 lifecycle, Tour of Duty Phase 1, Relief Readiness Phase 2A, Projected Manning Engine Phase 2B.1, Projected Manning UI Phase 2B.2, Dashboard projected card Phase 2B.3A, planning sync, sea service |
