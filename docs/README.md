...
| [Crew payroll timeline preparation](./architecture/crew-payroll-timeline-preparation.md) | Payroll, operations, developers | Phase 1A schema for future crew timeline preparation and approval |
