...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        $this->grantFromSource('documents.view', ['documents.templates.view']);
        $this->grantFromSource('bulk_documents.view', ['documents.templates.view']);
        $this->grantFromSource('documents.upload', [
            'documents.templates.create',
            'documents.templates.update',
        ]);
        $this->grantFromSource('documents.delete', [
            'documents.templates.delete',
        ]);
        $this->grantFromSource('bulk_documents.generate', [
            'documents.templates.create',
            'documents.templates.update',
        ]);
        $this->grantFromSource('bulk_documents.delete', [
            'documents.templates.delete',
        ]);
