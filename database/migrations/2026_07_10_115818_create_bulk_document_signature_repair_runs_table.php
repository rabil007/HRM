    ...
    public function up(): void
    {
        if (! Schema::hasTable('bulk_document_signature_repair_runs')) {
            Schema::create('bulk_document_signature_repair_runs', function (Blueprint $table) {
                ...
                $table->index(
                    ['company_id', 'document_type_key', 'status'],
                    'bdsrr_company_type_status_idx',
                );
            });
        ...
        Schema::table('bulk_document_signature_repair_runs', function (Blueprint $table) {
            if (! Schema::hasIndex('bulk_document_signature_repair_runs', 'bdsrr_company_type_status_idx')) {
                $table->index(
                    ['company_id', 'document_type_key', 'status'],
                    'bdsrr_company_type_status_idx',
                );
