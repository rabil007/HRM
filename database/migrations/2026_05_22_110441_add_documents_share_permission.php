...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        $share = Permission::query()->where('name', 'documents.share')->where('guard_name', 'web')->first();
    ...
    public function down(): void
    {
        ...
        Permission::query()->where('name', 'documents.share')->where('guard_name', 'web')->delete();
