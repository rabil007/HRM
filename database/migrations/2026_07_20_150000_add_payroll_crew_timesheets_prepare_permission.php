...
{
    private const PERMISSION = 'payroll.crew_timesheets.prepare';
    ...
    public function up(): void
    {
        ...
        $this->grantFromSource('payroll.crew_timesheets.create');
        $this->grantFromSource('payroll.crew_timesheets.update');
