...
return new class extends Migration
{
    ...
    public function down(): void
    {
        ...
        $reverseMap = [
            'sea_services.view' => 'employees.sea_service.manage',
            'sea_services.create' => 'employees.sea_service.manage',
            'sea_services.update' => 'employees.sea_service.manage',
            'sea_services.delete' => 'employees.sea_service.manage',
            'sea_services.import' => 'employees.sea_service.manage',
        ];
