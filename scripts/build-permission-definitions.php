...
$special = [
    ...
    'attendance.overview.view' => ['View Attendance Overview', 'Allows the user to view attendance analytics on the company dashboard for the active company.'],
    ...
    'crew_operations.assignments.create_historical' => ['Record Past Crew Data', 'Allows the user to record known past operational periods and bootstrap current crew state without replaying live movement side effects.'],
    ...
    'payroll.crew_timesheets.view' => ['View Crew Timesheets', 'Allows the user to view crew timesheet data on crew payroll periods for the active company.'],
    ...
    'payroll.crew_timesheets.update' => ['Update Crew Timesheets', 'Allows the user to update operational crew timesheet data (movement segments, overtime, remarks) on draft payroll periods.'],
    ...
    'payroll.crew_timesheets.prepare' => ['Prepare Crew Timesheets', 'Allows the user to populate draft crew timesheets from eligible Crew Assignment movement data on the payroll period page.'],
