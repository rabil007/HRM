...
$special = [
    ...
    'crew_operations.corrections.approve' => ['Approve Crew Movement Corrections', 'Allows the user to approve or reject crew movement correction requests assigned to them.'],
    'crew_operations.corrections.override' => ['Override Crew Movement Corrections', 'Allows the user to override correction workflow restrictions for high-trust administrative correction actions.'],
