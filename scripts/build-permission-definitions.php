...
$special = [
    ...
    'crew_operations.assignments.create_historical' => ['Record Historical Crew Assignments', 'Allows the user to record completed past crew movements and historical sea service without affecting active operations.'],
