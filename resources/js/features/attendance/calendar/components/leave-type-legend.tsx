        ...
        <div className="mt-1 space-y-0.5 text-[11px] text-muted-foreground">
            <div>
                <span className="font-bold text-foreground tabular-nums">
                    {formatDays(leaveType.remaining_days)}
                </span>
                <span> of </span>
...
export function LeaveTypeLegend({
    ...
    return (
        <Card className="overflow-hidden glass-card border-border/60 bg-card/80 dark:border-white/6 dark:bg-white/4">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <div>
                        ...
                        <p className="text-xs font-medium text-muted-foreground/75">
                            {showBalance
                                ? `Leave balance in ${year}`
                                : `Approved leave in ${year}`}
                        </p>
                    </div>
                </div>
            </CardHeader>
                    ...
                    >
                        <div className="flex items-start gap-3">
                            <span
                                ...
                                style={{
                                    backgroundColor:
                                        leaveType.color ?? FALLBACK_COLOR,
                                }}
                            />
                            <div className="min-w-0 flex-1">
                                <div className="flex items-center justify-between gap-2">
                                    ...
                                    <Badge
                                        variant="secondary"
                                        className="shrink-0 bg-muted/50 text-[10px] font-bold tracking-wider uppercase dark:bg-white/8"
                                    >
                                        {leaveType.code}
                                    </Badge>
                                </div>
