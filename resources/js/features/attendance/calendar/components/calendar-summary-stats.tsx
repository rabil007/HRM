...
function StatCard({
    ...
    const content = (
        <div
            className={cn(
                'group relative overflow-hidden rounded-2xl border glass-card border-border/60 bg-card/80 p-5 transition-all duration-300',
                href &&
                    'cursor-pointer hover:-translate-y-0.5 hover:border-border hover:shadow-lg dark:hover:border-white/10',
            )}
        >
            <div
                className={cn(
