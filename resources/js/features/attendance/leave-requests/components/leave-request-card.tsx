        ...
        <Card className="group relative overflow-hidden glass-card transition-all duration-300 dark:bg-linear-to-br dark:from-white/6 dark:to-white/3 dark:hover:from-white/8 dark:hover:to-white/4">
            ...
            <CardContent className="pt-0">
                <div className="grid gap-2 pb-16">
                    ...
                    {leaveRequest.reason ? (
                        <div className="line-clamp-2 rounded-xl border border-border/60 bg-muted/30 px-3 py-2 text-sm text-muted-foreground dark:border-white/6 dark:bg-white/4">
                            {leaveRequest.reason}
                        </div>
                    ) : null}
                    {leaveRequest.attachments[0] ? (
                        ...
                        >
                            ...
                            <span className="truncate">
                                {leaveRequest.attachments[0].name}
                            </span>
                        </a>
                    ) : null}
                </div>
