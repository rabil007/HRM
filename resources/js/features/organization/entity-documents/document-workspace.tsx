...
function DocumentActions({
    ...
    return (
        <div className="flex flex-wrap items-center justify-end gap-1">
            {permissions.download && document.can_preview ? (
                <Button
                    size="icon"
                    variant="ghost"
...
export function DocumentWorkspace({
    ...
    return (
        <Main>
            ...
            {documents.length === 0 ? (
                <EmptyState
                    title={emptyTitle ?? `No ${ownerType} documents found.`}
                />
            ) : view === 'grid' ? (
            ...
            <ConfirmDeleteDialog
                ...
                title={`Delete ${ownerType} document?`}
                ...
                onConfirm={() => {
                    ...
                    router.delete(routes.destroy(selected.id), {
                        preserveScroll: true,
                        onFinish: () => {
                            setDeleteOpen(false);
                            setSelected(null);
