...
export function buildOrgTree(
    ...
    departments.forEach((dept) => {
        ...
        const type =
            dept.parent_id === null ? 'parent_department' : 'child_department';
...
function OrgNodeCard({
    ...
    const handleClick = () => {
        if (
            node.type === 'parent_department' ||
            node.type === 'child_department'
        ) {
                ...
                >
                    ...
                    <div className="flex min-h-[70px] flex-col justify-between p-4">
                        ...
                        {node.users_count !== undefined && (
                            <span className="mt-1 text-xs font-semibold text-emerald-500 dark:text-emerald-400">
        ...
        <div className="overflow-x-auto rounded-xl border glass-card border-border/50 bg-background/50 p-8 backdrop-blur-sm">
            <div className="mb-8 flex flex-wrap items-center justify-between gap-4">
                ...
                <div className="flex flex-wrap items-center gap-6 text-sm font-medium">
                    ...
                    <div className="flex items-center gap-2">
                        <div className="h-3 w-3 rounded-full bg-orange-500/90" />
