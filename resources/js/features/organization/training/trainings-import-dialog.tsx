...
import {
    importMethod as importTrainings,
    importPreview,
    importTemplate,
} from '@/actions/App/Http/Controllers/Organization/TrainingsImportController';
...
export function TrainingsImportDialog({
    open,
    onOpenChange,
}: {
    open: boolean;
    ...
    const handleImport = () => {
        ...
        router.post(importTrainings.url(), formData, {
            forceFormData: true,
            preserveScroll: true,
            onSuccess: () => {
    ...
    return (
        <Dialog open={open} onOpenChange={handleOpenChange}>
            <DialogContent className="max-h-[90vh] overflow-hidden sm:max-w-4xl">
                <DialogHeader>
                    <DialogTitle>Import training</DialogTitle>
                    <DialogDescription>
                        Download the template with your active employees
                        pre-filled, fill course and dates, then upload. Rows
                        with no training data are skipped. Multiple rows per
                ...
                <div className="space-y-4 overflow-y-auto pr-1">
                    ...
                    >
                        ...
                        <p className="text-sm font-medium">
                            {file
                                ? file.name
                                : 'Drop your training file here or click to browse'}
                        </p>
                        <p className="mt-1 text-xs text-muted-foreground">
                            Training worksheet · .xlsx, .xls, .csv
                        </p>
                    </div>
                    ...
                    {preview ? (
                        <div className="space-y-3">
                            ...
                            <SearchBar
                                ...
                                placeholder="Search by employee no., course, or institute…"
                                className="mb-0"
