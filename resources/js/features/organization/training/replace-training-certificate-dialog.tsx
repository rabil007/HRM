...
export function ReplaceTrainingCertificateDialog({
    training,
    employeeId,
    onOpenChange,
    templateFields = null,
        ...
        <Dialog open={!!training} onOpenChange={handleOpenChange}>
            <DialogContent className="sm:max-w-md">
                <div className="relative">
                    ...
                    />
                    <DialogHeader>
                        <DialogTitle>Replace Training Certificate</DialogTitle>
                    </DialogHeader>
                    <div className="space-y-4 py-2">
                        <p className="text-sm text-muted-foreground">
                            The current certificate will be kept in version
                            history. Images are compressed in your browser. PDFs
                            larger than 5 MB are optimized on the server after
                            upload.
                        </p>
                    ...
                    <DialogFooter className="border-t border-border/60 pt-4">
                        ...
                        <Button
                            ...
                            onClick={() => {
                                ...
                                replaceForm.post(
                                    EmployeeTrainingController.replace.url({
                                        employee: employeeId,
