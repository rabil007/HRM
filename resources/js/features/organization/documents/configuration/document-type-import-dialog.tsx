...
export function DocumentTypeImportDialog({
    open,
    onOpenChange,
}: {
    open: boolean;
                ...
                <DialogHeader className="space-y-0 border-b border-border px-6 py-5 text-left sm:text-left">
                    <div className="flex gap-4">
                        ...
                        <div className="min-w-0 space-y-1.5 pt-0.5">
                            ...
                            <DialogDescription>
                                Add or update rows in bulk. Existing titles are
                                updated; new titles are created.
                            </DialogDescription>
                        </div>
                    </div>
                </DialogHeader>
                        ...
                        <AlertDescription>
                            ...
                            <ul className="list-inside list-disc space-y-1 text-muted-foreground">
                                ...
                                <li>
                                    ...
                                    — optional; use yes, true, 1, or active for
                                    enabled
                                </li>
                            </ul>
                        </AlertDescription>
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="rounded-xl border border-border/80 bg-muted/20 p-4">
                            <p className="text-sm text-muted-foreground">
                                Download a file with the correct column headers
                                so your import validates cleanly.
                            </p>
                            <Button
                                variant="secondary"
                                type="button"
