            ...
            <CardContent className="space-y-4 pt-0">
                <div className="grid grid-cols-2 gap-3">
                    <div className="p-3 rounded-xl bg-white/5 border border-white/5 text-center">
                        ...
                        <div className="text-lg font-bold">{branch.code || '—'}</div>
                    </div>
                    <div className="p-3 rounded-xl bg-white/5 border border-white/5 text-center">
                        <div className="text-xs font-medium text-muted-foreground uppercase tracking-widest mb-1">
                            HQ
                        </div>
                        <div className="text-lg font-bold">{branch.is_headquarters ? 'Yes' : 'No'}</div>
                    </div>
                </div>

                <div className="space-y-2.5">
                    {branch.phone ? (
                        <div className="flex items-center gap-3 text-xs font-medium text-muted-foreground py-2 px-3 rounded-lg bg-white/5 border border-white/5">
