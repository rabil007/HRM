...
import {
    employeesAvailableForUser,
    formatEmployeeLinkLabel,
} from '../lib/employees-for-user-link';
...
export function UserFormSheet({
    ...
    if (uploadPreviewUrl && avatarFileName) {
        ...
        avatarHint =
            'Current profile photo. Upload a file or use the employee photo to replace it.';
    } else if (canUseEmployeePhoto) {
        avatarHint =
            'No profile photo yet. Upload an image or use the linked employee photo.';
    } else if (!form.data.employee_id) {
        avatarHint =
            'Link an employee below to enable “Use employee photo”, or upload an image.';
    }
                    ...
                    <div className="space-y-5">
                        ...
                        <div className="space-y-2">
                                ...
                                onValueChange={(value) => {
                                    ...
                                    form.setData((data) => ({
                                        ...
                                        use_employee_avatar:
                                            ...
                                            Boolean(nextEmployee?.image_url),
                                    }));
                                }}
                                variant="card"
                                placeholder={
                            ...
                            <p className="text-xs text-muted-foreground/80">
                                Map this login to an employee record. Only
                                unlinked employees (or the current link) are
                                listed.
                            </p>
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-xs text-muted-foreground/70">
                                Use a long, random password with mixed case,
                                numbers, and symbols.
                            </p>
