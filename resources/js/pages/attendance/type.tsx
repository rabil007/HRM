        ...
        <Main>
                ...
                <Card className="glass-card border-border bg-card dark:border-white/5 dark:bg-white/5">
                    ...
                    <CardContent className="p-0">
                        <div className="divide-y divide-border dark:divide-white/5">
                            ...
                            <Field
                                label="Days per year"
                                value={String(leave_type.days_per_year)}
                            />
                            <Field
                                label="Carry forward"
                                value={leave_type.carry_forward ? 'Yes' : 'No'}
                            />
                            <Field
                    ...
                    <CardContent className="p-0">
                        <div className="divide-y divide-border dark:divide-white/5">
                            <Field
                                ...
                                value={String(leave_type.leave_requests_count)}
                            />
                            <Field
                                label="Created"
                                value={
            ...
            {can_view_audit ? (
                <RecentActivityCard
                    ...
                    description="Latest changes for this type."
                />
            ) : null}
