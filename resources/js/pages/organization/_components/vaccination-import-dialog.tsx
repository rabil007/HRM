...
import { importMethod, importTemplate } from '@/actions/App/Http/Controllers/Organization/EmployeeVaccinationController';
...
export function VaccinationImportDialog({ open, onOpenChange, employeeId }: VaccinationImportDialogProps) {
                ...
                <DialogHeader className="space-y-0 border-b border-border px-6 py-5 text-left sm:text-left">
                    <div className="flex gap-4">
                        ...
                        <div className="min-w-0 space-y-1.5 pt-0.5">
                            <DialogTitle className="text-xl leading-tight">Import vaccinations</DialogTitle>
                            <DialogDescription>
                ...
                <div className="space-y-5 px-6 py-5">
                    <Alert className="border-border/80 bg-muted/40">
                        ...
                        <AlertDescription>
                            ...
                            <ul className="list-inside list-disc space-y-1 text-muted-foreground">
                                <li>
                                    <span className="font-medium text-foreground">vaccination_name</span> — required (aliases: Vaccination, Vaccine,
                                    Immunization)
                                </li>
                                <li>
                                    <span className="font-medium text-foreground">country</span> — optional; name must match master data (e.g.
                                    United Arab Emirates)
                                </li>
                                <li>
                                    <span className="font-medium text-foreground">first_dose, second_dose, booster_dose</span> — optional dates
                                    (YYYY-MM-DD or locale formats Carbon accepts)
                                </li>
                            </ul>
                        </AlertDescription>
                    </Alert>
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="rounded-xl border border-border/80 bg-muted/20 p-4">
                            <p className="text-sm text-muted-foreground">Use the sample headers. Dates are optional on each row.</p>
                    ...
                    <div className="space-y-2">
                        ...
                        <input
                            ...
                            className="sr-only"
                            id={`vaccination-import-${employeeId}`}
                            onChange={(event) => {
