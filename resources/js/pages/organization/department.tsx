...
export default function DepartmentDetails({
    ...
    const sheetDepartment: SheetDepartment = useMemo(() => {
        return {
            id: department.id,
            company: {
                id: department.company.id ?? 0,
                name: department.company.name ?? null,
            },
            branch: department.branch
                ? {
                      id: department.branch.id,
                      name: department.branch.name ?? null,
                  }
                : null,
            parent: department.parent
                ? {
                      id: department.parent.id,
                      name: department.parent.name ?? null,
                  }
                : null,
                    ...
                    <CardContent className="p-0">
                        <div className="divide-y divide-border dark:divide-white/5">
                            {child_departments.map((child) => (
                                <div
                                    key={child.id}
                                    className="flex items-center justify-between px-6 py-4 transition-colors hover:bg-muted/30 dark:hover:bg-white/[0.015]"
                                >
                                    <div className="space-y-1">
