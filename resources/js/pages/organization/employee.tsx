                                            ...
                                            <table className="w-full min-w-[900px] text-left">
                                                ...
                                                <tbody className="divide-y divide-white/5">
                                                    {documents.map((doc) => {
                                                        ...
                                                        const statusColor = statusColors[doc.status ?? ''] ?? 'bg-white/5 text-zinc-400 border-white/10';

                                                        return (
                                                            <tr key={doc.id} className="text-sm text-zinc-200">
                                                                <td className="py-3 pr-4 text-zinc-400 text-xs">
                                                                    {document_types.find(t => t.slug === doc.document_type || String(t.id) === doc.document_type)?.title ?? doc.document_type ?? doc.type ?? '—'}
                                                                </td>
                                                                ...
                                                                <td className="py-3 pr-4">
                                                                    <a href={doc.file_url} target="_blank" rel="noreferrer" className="text-xs font-semibold text-primary hover:underline">
                                                                        View
                                                                    </a>
                                                                </td>
                                                                {(can.documents_upload || can.documents_delete) && (
                                    ...
                                    <DialogContent className="sm:max-w-md">
                                        ...
                                        <div className="space-y-4 py-2">
                                            <div className="space-y-1.5">
                                                ...
                                                {uploadForm.errors.document_type && <p className="text-xs text-destructive">{uploadForm.errors.document_type}</p>}
                                            </div>
                                            <div className="space-y-1.5">
                                                <Label className="text-xs">Title</Label>
                                                <Input className="h-9 text-sm" placeholder="e.g. Passport Copy" value={uploadForm.data.title} onChange={e => uploadForm.setData('title', e.target.value)} />
                                            </div>
                                            <div className="space-y-1.5">
                                                ...
                                                />
                                                {uploadForm.errors.file && <p className="text-xs text-destructive">{uploadForm.errors.file}</p>}
                                            </div>
                                            <div className="grid grid-cols-2 gap-3">
                                                <div className="space-y-1.5">
                                                    <Label className="text-xs">Document Number</Label>
                                                    <Input className="h-9 text-sm" placeholder="e.g. A123456" value={uploadForm.data.document_number} onChange={e => uploadForm.setData('document_number', e.target.value)} />
                                                </div>
                                                <div className="space-y-1.5">
                                                    <Label className="text-xs">Issue Date</Label>
                                                    <Input type="date" className="h-9 text-sm" value={uploadForm.data.issue_date} onChange={e => uploadForm.setData('issue_date', e.target.value)} />
                                                </div>
                                                <div className="space-y-1.5">
                                                    <Label className="text-xs">Expiry Date</Label>
                                                    <Input type="date" className="h-9 text-sm" value={uploadForm.data.expiry_date} onChange={e => uploadForm.setData('expiry_date', e.target.value)} />
                                                </div>
                                            </div>
                                            <div className="space-y-1.5">
