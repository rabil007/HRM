...
export default function EmployeeDetails({
    ...
    const tabs = [
        ...
        { id: 'languages', label: 'Languages', count: languages.length || null },
                            ...
                            <TabsContent value="languages" className="mt-6">
                                <div className="rounded-2xl border border-white/10 bg-card/70 p-5 shadow-lg shadow-black/10 backdrop-blur-xl">
                                    <div className="mb-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                                        <h3 className="text-sm font-semibold text-zinc-200">
                                            Languages
                                            <span className="ml-2 text-xs font-normal text-zinc-500">{languages.length} total</span>
                                        </h3>
                                        {can.languages_manage ? (
                                            <Button
                                                size="sm"
                                                className="h-8 gap-1.5 text-xs"
                                                type="button"
                                    ...
                                    {languages.length === 0 ? (
                                        <div className="py-10 text-center text-sm text-zinc-500">No languages recorded.</div>
                                    ) : (
                                        <div className="overflow-x-auto">
                                            <table className="w-full min-w-[720px] text-left">
                                                <thead>
                                                    <tr className="border-b border-white/5 text-xs font-semibold text-zinc-500">
                                                        ...
                                                        <th className="py-2 pr-4 text-center">Spoken</th>
                                                        <th className="py-2 pr-4 text-center">Written</th>
                                                        <th className="py-2 pr-4 text-center">Understood</th>
                                                        <th className="py-2 pr-4 text-center">Mother tongue</th>
                                                        <th className="py-2 pr-4">Added</th>
                                                        {can.languages_manage ? <th className="py-2 pr-4 text-right" /> : null}
                                                    </tr>
                                                </thead>
                                                <tbody className="divide-y divide-white/5">
                                                    {languages.map((row) => (
                                                        <tr key={row.id} className="text-sm text-zinc-200">
                                                            <td className="max-w-[220px] truncate py-3 pr-4 font-medium" title={row.language_name}>
                                                                {row.language_name}
                                                            </td>
                                                            <td className="py-3 pr-4 text-center text-xs">
                                                                {row.is_spoken ? <span className="text-emerald-400">✓</span> : <span className="text-zinc-600">—</span>}
                                                            </td>
                                                            <td className="py-3 pr-4 text-center text-xs">
                                                                {row.is_written ? <span className="text-emerald-400">✓</span> : <span className="text-zinc-600">—</span>}
                                                            </td>
                                                            <td className="py-3 pr-4 text-center text-xs">
                                                                {row.is_understood ? <span className="text-emerald-400">✓</span> : <span className="text-zinc-600">—</span>}
                                                            </td>
                                                            <td className="py-3 pr-4 text-center text-xs">
                                                                {row.is_mother_tongue ? <span className="text-emerald-400">✓</span> : <span className="text-zinc-600">—</span>}
                                                            </td>
                                                            <td className="whitespace-nowrap py-3 pr-4 text-xs text-zinc-500">
                                                                {new Date(row.created_at).toLocaleString(undefined, {
                                                                    month: 'short',
                                                                ...
                                                                <td className="py-3 pr-0 text-right">
                                                                    <div className="flex items-center justify-end gap-2">
                                                                        ...
                                                                        <button
                                                                            type="button"
                                                                            className="text-xs text-red-400/60 transition-colors hover:text-red-400"
                                                                            onClick={() => setDeleteLanguageId(row.id)}
                                                                        >
                                                                            Delete
                                                                        </button>
                                                                    </div>
                                ...
                                >
                                    <DialogContent className="sm:max-w-md">
                                        ...
                                        <DialogFooter>
                                            <Button variant="outline" size="sm" type="button" onClick={() => setLanguageDialogOpen(false)}>
                                                Cancel
                                            </Button>
                                            <Button
                                                size="sm"
                                                ...
                                                onClick={() => {
                                                    ...
                                                    const url = editingLanguage
                                                        ...
                                                        : storeLanguage.url({ employee: employee.id });
