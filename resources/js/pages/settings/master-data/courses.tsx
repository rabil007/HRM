...
export default function Courses({ courses }: { courses: Course[] }) {
    ...
    const submit = () => {
        if (current) {
            form.put(`/settings/master-data/courses/${current.id}`, {
                preserveScroll: true,
        ...
        form.post('/settings/master-data/courses', {
            preserveScroll: true,
            onSuccess: () => setSheetOpen(false),
        });
    };
    ...
    const confirmDelete = () => {
        ...
        router.delete(`/settings/master-data/courses/${current.id}`, {
            preserveScroll: true,
            onFinish: () => {
                setDeleteOpen(false);
                setCurrent(null);
    ...
    const toggleActive = (course: Course) => {
        router.put(
            `/settings/master-data/courses/${course.id}`,
            {
                name: course.name,
                is_active: !course.is_active,
            },
    ...
    const runImport = () => {
        ...
        router.post(
            '/settings/master-data/courses/import',
            { file: importFile },
            {
                preserveScroll: true,
                forceFormData: true,
    ...
    return (
        <>
            ...
            <div className="space-y-6">
                <Heading variant="small" title="Courses" description="Manage course titles used across the system." />
                ...
                <div className="rounded-xl border border-border/60 overflow-hidden">
                    <div className="overflow-x-auto">
                        <div className="min-w-[640px]">
                            ...
                            {rows.length === 0 ? (
                                <div className="px-4 py-10 text-sm text-muted-foreground">No courses found.</div>
                            ) : null}
                        </div>
                    </div>
                </div>
                    ...
                    <DialogHeader className="space-y-0 border-b border-border px-6 py-5 text-left sm:text-left">
                        <div className="flex gap-4">
                            ...
                            <div className="min-w-0 space-y-1.5 pt-0.5">
                                <DialogTitle className="text-xl leading-tight">Import courses</DialogTitle>
                                <DialogDescription>
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="rounded-xl border border-border/80 bg-muted/20 p-4">
                                ...
                                <Button variant="secondary" type="button" className="mt-3 w-full sm:w-auto" asChild>
                                    <a href="/settings/master-data/courses/import/template">
