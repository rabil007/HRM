    ...
    return (
        <>
            ...
            <div className="space-y-6">
                <Heading variant="small" title="Ranks" description="Manage ranks used across the system." />

                <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    <div className="flex-1">
                        <Input value={query} onChange={(e) => setQuery(e.target.value)} placeholder="Search ranks..." />
                    </div>
                    <div className="flex flex-wrap items-center gap-2 sm:justify-end">
                        ...
                        {can.create ? <Button onClick={openCreate}>Add rank</Button> : null}
                    </div>
                </div>
                ...
                <div className="rounded-xl border border-border/60 overflow-hidden">
                    <div className="overflow-x-auto">
                        <div className="min-w-[640px]">
                            ...
                            {rows.length === 0 ? (
                                <div className="px-4 py-10 text-sm text-muted-foreground">No ranks found.</div>
                            ) : null}
                        </div>
                    </div>
                </div>
                    ...
                    <DialogHeader className="space-y-0 border-b border-border px-6 py-5 text-left sm:text-left">
                        <div className="flex gap-4">
                            ...
                            <div className="min-w-0 space-y-1.5 pt-0.5">
                                <DialogTitle className="text-xl leading-tight">Import ranks</DialogTitle>
                                <DialogDescription>
            ...
            <AlertDialog open={deleteOpen} onOpenChange={setDeleteOpen}>
                <AlertDialogContent className="glass-card">
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            {current ? `This will permanently delete “${current.name}”.` : 'This will permanently delete this rank.'}
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
