...
const SETTINGS_GROUPS = [
    ...
    },
    {
        ...
        items: [
            ...
            { title: 'Company Visa Types', href: '/settings/master-data/company-visa-types', icon: IdCard, color: 'bg-cyan-500/10 text-cyan-600' },
            { title: 'Approval Locations', href: '/settings/master-data/approval-locations', icon: MapPin, color: 'bg-teal-500/10 text-teal-600' },
            { title: 'SSSA Options', href: '/settings/master-data/sssa-options', icon: MapPin, color: 'bg-teal-500/10 text-teal-600' },
