...
@section('content')
    ...
    <tr>
        <td style="padding:24px 32px;">
            ...
            @if ($status === 'rejected' && filled($rejectionReason) && $rejectionReason !== '—')
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="margin:0 0 24px;border:1px solid #e4e4e7;border-radius:12px;overflow:hidden;background-color:#fafafa;">
                    <tr>
                        <td style="padding:16px;">
                            <p style="margin:0 0 6px;font-size:11px;font-weight:600;color:#71717a;text-transform:uppercase;letter-spacing:0.08em;">Reason for decline</p>
                            <p class="email-text" style="margin:0;font-size:14px;line-height:1.5;color:#18181b;white-space:pre-wrap;">{{ $rejectionReason }}</p>
                        </td>
                    </tr>
                </table>
            @endif
