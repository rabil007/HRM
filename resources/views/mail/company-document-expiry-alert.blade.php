...
@section('title', "Company Document Expiry Alert - Next {$alertWindowDays} Days")
    ...
    <tr>
        <td style="padding:28px 32px 16px;border-bottom:1px solid #e4e4e7;">
            ...
            <p style="margin:8px 0 0;font-size:13px;color:#71717a;">
                Company documents expiring within the next {{ $alertWindowDays }} days
            </p>
        </td>
    </tr>
    <tr>
        <td style="padding:24px 32px;">
            <p style="margin:0 0 16px;font-size:15px;line-height:1.6;color:#3f3f46;">
                The following company documents require attention before they expire.
            </p>
            ...
            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="border:1px solid #e4e4e7;border-radius:8px;overflow:hidden;border-collapse:collapse;">
                <thead>
                    <tr style="background-color:#f4f4f5;">
                        ...
                        <th align="left" style="padding:12px 16px;font-size:12px;font-weight:600;color:#18181b;border-bottom:1px solid #e4e4e7;">Document Number</th>
            ...
            <p style="margin:20px 0 0;font-size:12px;line-height:1.6;color:#a1a1aa;">
                These are company-level documents. Employee document expiry notifications are sent separately.
            </p>
        </td>
    </tr>
@endsection
