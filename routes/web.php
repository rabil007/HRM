...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::post('organization/crew-planning/assignments/{assignment}/create-crew-assignment', [CrewPlanningAssignmentController::class, 'createCrewAssignment'])->middleware(['can:crew_operations.assignments.create', 'can:crew_operations.movements.perform'])->name('organization.crew-planning.assignments.create-crew-assignment');
    Route::post('organization/crew-planning/assignments/{assignment}/start', [CrewPlanningAssignmentController::class, 'startAssignment'])->middleware(['can:crew_operations.assignments.create', 'can:crew_operations.movements.perform'])->name('organization.crew-planning.assignments.start');
    ...
    Route::get('payroll/{payrollPeriod}/crew-timeline/{preparation}', CrewTimesheetPreparationShowController::class)
        ->middleware('can:payroll.crew_timesheets.view')
        ->name('payroll.crew-timeline.show');
    Route::post('payroll/{payrollPeriod}/crew-timeline/{preparation}/submit', SubmitCrewTimesheetPreparationController::class)
        ->middleware('can:payroll.crew_timesheets.submit')
        ->name('payroll.crew-timeline.submit');
    Route::post('payroll/{payrollPeriod}/crew-timeline/{preparation}/approve', ApproveCrewTimesheetPreparationController::class)
        ->middleware('can:payroll.crew_timesheets.approve')
        ->name('payroll.crew-timeline.approve');
    ...
    Route::post('organization/employees/{employee}/training', [EmployeeTrainingController::class, 'store'])->middleware('can:training.create')->name('organization.employees.training.store');
    Route::put('organization/employees/{employee}/training/{training}', [EmployeeTrainingController::class, 'update'])->middleware('can:training.update')->name('organization.employees.training.update');
    Route::post('organization/employees/{employee}/training/{training}/replace', [EmployeeTrainingController::class, 'replace'])->middleware('can:training.update')->name('organization.employees.training.replace');
    Route::delete('organization/employees/{employee}/training/bulk', [EmployeeTrainingController::class, 'bulkDestroy'])->middleware('can:training.delete')->name('organization.employees.training.bulk-destroy');
    Route::delete('organization/employees/{employee}/training/{training}', [EmployeeTrainingController::class, 'destroy'])->middleware('can:training.delete')->name('organization.employees.training.destroy');
