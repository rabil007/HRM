...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::put('organization/employees/{employee}/contracts/{employeeContract}/salary-revisions/{salaryRevision}', [ContractSalaryRevisionController::class, 'update'])->middleware('can:contracts.salary_revisions.manage')->name('organization.employees.contracts.salary-revisions.update');
    Route::delete('organization/employees/{employee}/contracts/{employeeContract}/salary-revisions/{salaryRevision}', [ContractSalaryRevisionController::class, 'destroy'])->middleware('can:contracts.salary_revisions.manage')->name('organization.employees.contracts.salary-revisions.destroy');
